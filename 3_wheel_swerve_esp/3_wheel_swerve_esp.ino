...
#define chooseButton_0 B11110000  //choose the button which needs to be used;  0: not to be used; 1: to be used
#define chooseButton_1 B01000000  //choose the button which needs to be used;  0: not to be used; 1: to be used
#define chooseButton_2 B01001100  //choose the button which needs to be used;  0: not to be used; 1: to be used
#define buttonMode_0   B00001111  // 0: on press; 1: on click
...
#define printData_0    B11110000  // choose which button data to be printed
#define printData_1    B01000000  // choose which button data to be printed
