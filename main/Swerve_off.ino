...
public:
  Module(uint8_t indexx, uint8_t r_pwmx, uint8_t l_pwmx, Encoder &encox, ODriveUART &odrivex, int pwmx, long cprx)
...
void loop() {
  ...
  Serial.println((String) " Angle1:" + angle1 + " velocity1:" + velocity1 + "\tAngle2:" + angle2 + " velocity2:" + velocity2 + "\tAngle3:" + angle3 + " velocity3:" + velocity3 + "\tAngle4:" + angle4 + " velocity:" + velocity4);
